...
void loop() {
  ...
  {
    Serial.println("IF 4");
    if (cursor_position_y_var < (cursor_position_y + 2) && cursor_position_y_var > (cursor_position_y - 1))
    {
      cursor_position_y_var = cursor_position_y_var + 1;
      lcd.setCursor (cursor_position_y_var, cursor_position_x_var);
      delay(250);
    }
    else if (cursor_position_y_var > (cursor_position_y + 1) && cursor_position_y_var > (cursor_position_y - 1))
    { Serial.println("IF 4.4");
      cursor_position_y_var = cursor_position_y;
      lcd.setCursor (cursor_position_y_var, cursor_position_x_var);
      lcd.cursor();
      delay(250);
